...
- [ ] SleepCheck polish pass (bugs, a11y, responsive, performance)  
- [ ] Local history / sessions design notes (implementation may start here or slip to 60-day)  
- [ ] Identify candidate shared components (list only; extract only if obvious)  

### Documentation

- [ ] Per-app architecture notes linked from app READMEs  
- [ ] Keep [../ROADMAP.md](../ROADMAP.md) checkboxes honest  
- [ ] Diagrams in this repo used in article drafts  
...
- [ ] Define simple feedback channel (form, email, or GitHub Discussions)  
- [ ] Capture top friction points from real users  

## Explicit non-goals (30 days)

- Full shared auth across apps  
- New Check application domains  
- Relicensing MIT showcase repos  
- Private commercial strategy docs in this public repo  
