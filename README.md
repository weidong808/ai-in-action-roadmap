...
| **HabitCheck** | Scaffold started (App #4) | [HabitCheck](https://github.com/weidong808/HabitCheck) | [MVP spec](./docs/discovery/habitcheck-02-mvp-specification.md) |
...
- HabitCheck (AI in Action #4) **P0 scaffold started** — public repo [HabitCheck](https://github.com/weidong808/HabitCheck); MVP v5 AI-forward ([spec](./docs/discovery/habitcheck-02-mvp-specification.md))
